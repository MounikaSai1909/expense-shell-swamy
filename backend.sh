...
cp /home/ec2-user/expense-shell-swamy/backend.service /etc/systemd/system/backend.service
...
mysql --host=54.172.122.51 --user=root --password=${mysql_root_password} < /app/schema/backend.sql &>>$LOGFILE
